function Noeud(texte) {
	...
	this.particle.position = new Vector(previousNodeX+random(-20,20), previousNodeY+random(-20,20) , previousNodeZ+random(-20,20));
...
Noeud.prototype.draw = function() {
	...
	if (afficheTexte) {
		...
		texture(this.img);
        //	box(80, 80, 80);
        if (this.particle.position.z>centroid.z()){
