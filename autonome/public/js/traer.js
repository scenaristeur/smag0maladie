 ...
 */
function Spring(a, b, k, d, l, propriete) {
  this.constant = k;
  this.damping = d;
  this.length = l;
  this.a = a;
...
Attraction.prototype.getLength = function() {
	return this.length;
}
/**
...
ParticleSystem.prototype.makeSpring = function(a, b, k, d, l, propriete) {
  var s = new Spring(a, b, k, d, l, propriete);
  this.springs.push(s);
  return s;
};
...
Smoother3D.prototype.setXTarget = function(X) {
  this.x0.setTarget(X);
};
Smoother3D.prototype.setYTarget = function(Y) {
  this.y0.setTarget(Y);
};
Smoother3D.prototype.setZTarget = function(Z) {
  this.z0.setTarget(Z);
};
Smoother3D.prototype.getXTarget = function() {
  return x0.getTarget();
};
Smoother3D.prototype.getYTarget = function() {
  return this.y0.getTarget();
};
Smoother3D.prototype.getZTarget = function() {
  return this.z0.getTarget();
};
Smoother3D.prototype.setTarget = function(X, Y, Z) {
  this.x0.setTarget(X);
  this.y0.setTarget(Y);
  this.z0.setTarget(Z);

};
Smoother3D.prototype.setValue = function(X, Y, Z) {
  this.x0.setValue(X);
  this.y0.setValue(Y);
  this.z0.setValue(Z);
